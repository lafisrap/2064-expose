...
export default {
    title: '2 0 6 4',
    subtitle: 'Wie die Cypherpunks das Internet befreiten',
    introduction: {
        title: 'Im Jahr 2064 ...',
        teaser: [
    ...
    samples: {
        title: 'Lese-Proben (zwei Zeitebenen)',
        stories2023: [{
            tabName: 'Marlene (2021)',
            tabIcon: Face,
            tabTitle: 'Marlene',
            tabContent: [
                '(Im Jahr 2021 ...)',
                `Marlene gähnte. Deutsch-Unterricht, 10. Klasse, gedrückte Langeweile im Raum.
        ...
        Genau sein.`
            ...
            tabName: 'Marwin (2023)',
            tabIcon: Face,
            tabTitle: 'Zwei Jahre später ...',
            tabContent: [
                `Marwins Gefängniszelle war drei mal zwei Meter groß.
        ...
        Es war stockfinster.
        Aber es war die meiste Zeit stockfinster.`,
        ...
        Du stinkst zum Himmel.“`,
            ...
            tabTitle: 'Linda',
            tabContent: [
                `Marwin saß allein mit finsterer Miene im Besprechungsraum.
        ...
        Es war regelrecht durchlöchert, jede Menge Leute, nicht nur die Geheimdienste, konnten auf alle Computer zugreifen, auf die sie zugreifen wollten.`
            ...
            tabContent: [
                '(nach einer Runde in TRON, einem Simulationsspiel, das die Zeit von 2021 bis 2033 nachbildet)',
        ...
        Das war ein Computer-Programm, oder?“`,
                ...
                `Lilly: „Klar! Da habe ich den halben Abend gestern dran geschrieben.
        ...
        Und der andere hat gekauft.“`,
                ...
                `„Blödsinn!“
        Sigur schüttelte den Kopf.
        „Schwachstellen verkaufen?!
        Vielleicht wenn du die Mafia spielst, aber sonst nicht.
        ...
        Und Marie gibt dir die Informationen, weil ihr auch normal befreundet seid.“`,
                ...
                `„Überhaupt nicht.
        Ich habe zwei Computer von Hackerinnen für sie geknackt. Die braucht sie für ihre Mission.
    ...
    interviews: {
        ...
        Ha! Viel Glück! Ihr habt keine Chance.“
        Und ich kannte die Jungs im Geheimdienst, aus dem Gefängnis, ich war da zwei Jahre drin.
        Und dann hat sie sie wirklich erwischt, dann mussten sie ihren Schwanz einziehen.
        ...
        Und außerdem, Marwin war schon auch ein sturer Kopf, er hat das Ganze im letzten Augenlick nochmal in Gefahr gebracht.`,
    ...
    quotes: {
      ...
      `
        ...
        Du transportierst sie leichtfüßig über Mariannes Geschichte und hast so das Zeug, tatsächlich ein wichtiges Werk in puncto Jugendliteratur für kommende Generationen zu schreiben und im besten Falle eine Debatte anzustoßen, die lange überfällig ist.`
            ...
            name: 'Thomas Pedroli, Coach, Seminarleiter',
            icon: Face,
            font: 'handFont3',
            text: [`
        ...
        Und insgesamt: Wow!!!!!!! Mehr!`
            ...
            name: 'Christian V., Software-Entwickler / Viel-Leser',
            icon: Face,
            font: 'handFont3',
            text: [`
        Hab selten ein Buch so verschlungen wie 2064, weil ich unbedingt wissen
        wollte wie die Geschichte weitergeht. Und auch sehr toll, wie die
        Zeitebenen ineinander gearbeitet sind.`
            ]
        }]
    }
};
